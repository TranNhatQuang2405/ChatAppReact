        ...
        <div className="Message__Content-Left">
          <div className="nodeChildMessage">
            <div className="childMessage">
              <span>
                kubr _ 1 năm trước (đã chỉnh sửa) “No matter how many people you
                may lose you have no choice but to go on living. No matter how
                devastating the blows may be.”
              </span>
          ...
          <div className="nodeChildMessage-Right">
            <div className="childMessage">
              ...
              <div className="d-flex">
                <div className="childMessage-hour">12:00 AM</div>
                {showSend ? <div className="showSend">Đã gửi</div> : <></>}
              </div>
            </div>
            <div className="messageAction">
              <Dropdown>
